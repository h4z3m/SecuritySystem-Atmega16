 ...
 *                                Definitions                                  *
 *******************************************************************************/
/* Define PWM_MODE if needed, otherwise output will always be 100% duty cycle */
/*#define PWM_MODE*/
...
#define DCMOTOR_ENA_PIN PIN5_ID
#define DCMOTOR_IN1_PIN	PIN6_ID
#define DCMOTOR_IN2_PIN PIN7_ID
